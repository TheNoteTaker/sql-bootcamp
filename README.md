...
- [MySQL Master Bootcamp](#user-content-mysql-master-bootcamp)
  - [General Notes](#user-content-general-notes)
- [Section 2: Overview](#user-content-section-2-overview)
  - [General Notes](#user-content-general-notes-1)
  - [What is a Database?](#user-content-what-is-a-database)
  - [Database vs Database Management System](#user-content-database-vs-database-management-system)
  - [MySQL vs SQL](#user-content-mysql-vs-sql)
  - [Using Goorm and SQL](#user-content-using-goorm-and-sql)
  - [What is a Table?](#user-content-what-is-a-table)
  - [Different Types in SQL](#user-content-different-types-in-sql)
  - [Creating Tables](#user-content-creating-tables)
- [Section 4: Inserting Data (And More)](#user-content-section-4-inserting-data-and-more)
  - [General Notes](#user-content-general-notes-2)
  - [Multiple Inserts](#user-content-multiple-inserts)
  - [NULL and NOT NULL](#user-content-null-and-not-null)
  - [Setting Default Values](#user-content-setting-default-values)
  - [Primary Keys](#user-content-primary-keys)
  - [CRUD](#user-content-crud)
- [Section 7: String Functions](#user-content-section-7-string-functions)
  - [General Notes](#user-content-general-notes-3)
  - [Concat](#user-content-concat)
  - [Substring](#user-content-substring)
  - [Replace](#user-content-replace)
  - [Reverse](#user-content-reverse)
  - [Char_Length](#user-content-char_length)
  - [UPPER and LOWER](#user-content-upper-and-lower)
- [Section 8: Refining Our Selections](#user-content-section-8-refining-our-selections)
  - [General Notes](#user-content-general-notes-4)
  - [Distinct](#user-content-distinct)
  - [ORDER BY](#user-content-order-by)
  - [Limit](#user-content-limit)
  - [Like](#user-content-like)
- [Section 9: Aggregate Functions](#user-content-section-9-aggregate-functions)
  - [General Notes](#user-content-general-notes-5)
  - [Count](#user-content-count)
  - [Group By](#user-content-group-by)
  - [MIN and MAX](#user-content-min-and-max)
  - [Sum](#user-content-sum)
  - [Avg](#user-content-avg)
  - [Round](#user-content-round)
- [Section 10: Data Types](#user-content-section-10-data-types)
  - [General Notes](#user-content-general-notes-6)
  - [VARCHAR vs CHAR](#user-content-varchar-vs-char)
  - [Int](#user-content-int)
  - [Decimal](#user-content-decimal)
  - [Float and Double](#user-content-float-and-double)
  - [Dates, Times, DateTimes](#user-content-dates-times-datetimes)
- [Section 11: Logical Operators](#user-content-section-11-logical-operators)
  - [General Notes](#user-content-general-notes-7)
  - [Not Equal or !=](#user-content-not-equal-or-)
  - [Not Like](#user-content-not-like)
  - [Greater Than or >](#user-content-greater-than-or-)
  - [Greater Than or Equal To or >=](#user-content-greater-than-or-equal-to-or-)
  - [Less Than or >](#user-content-less-than-or-)
  - [Less Than or Equal To or >=](#user-content-less-than-or-equal-to-or-)
  - [Logical AND or &&](#user-content-logical-and-or-)
  - [Logical OR or ||](#user-content-logical-or-or-)
  - [Cast](#user-content-cast)
  - [Between](#user-content-between)
  - [Not Between](#user-content-not-between)
  - [IN and NOT IN](#user-content-in-and-not-in)
  - [Modulo or %](#user-content-modulo-or-)
  - [Case Statements](#user-content-case-statements)
- [Section 12: Relationships - One to Many](#user-content-section-12-relationships---one-to-many)
  - [General Notes](#user-content-general-notes-8)
  - [Types of Relationships](#user-content-types-of-relationships)
  - [One To Many](#user-content-one-to-many)
- [Section 14: Many-To-Many](#user-content-section-14-many-to-many)
  - [General Notes](#user-content-general-notes-9)
  - [Working With Data](#user-content-working-with-data)
- [Section 14: Instagram Database Clone](#user-content-section-14-instagram-database-clone)
  - [General Notes](#user-content-general-notes-10)
  - [Designing the Schema](#user-content-designing-the-schema)
  - [Tagging Solutions:](#user-content-tagging-solutions)
  - [Creating The Tables](#user-content-creating-the-tables-1)
  - [Inserting The Values](#user-content-inserting-the-values)
  - [Having](#user-content-having)
- [Section 16: Introducing Node](#user-content-section-16-introducing-node)
  - [What is Node?](#user-content-what-is-node)
- [Section 17: Building The Web App](#user-content-section-17-building-the-web-app)
  - [General Notes](#user-content-general-notes-11)
  - [NPM](#user-content-npm)
  - [EJS (Embedded Javascript)](#user-content-ejs-embedded-javascript)
- [Section 18: Database Triggers](#user-content-section-18-database-triggers)
  - [General Notes](#user-content-general-notes-12)
  - [Examples](#user-content-examples)
- [Further Learning](#user-content-further-learning)
